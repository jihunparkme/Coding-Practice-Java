...
public class BOJ17136 {
	...
	static int N = 10, oneCnt, map[][], paperState[];
...
//			System.out.println(paperCnt);
		...
		if(map[r][c] == 1) {
			...
			// 모든 스티커를 붙일 수 없는 상황이면 그냥 넘기기
//			if(!isPossible) go(idx + 1, paperCnt);
		} else {
			// 색종이를 붙일 수 없는 경우
			go(idx + 1, paperCnt);
		}
	...
	private static void setPaper(int r, int c, int p) {
